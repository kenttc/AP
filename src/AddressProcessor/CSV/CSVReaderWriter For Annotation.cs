...
namespace AddressProcessing.CSV
{
    /*
        ...
        *)output could use stringbuilder as it's mutable instead of string + which is immutable  ( ok googled - as seen in actual code, string.join is faster for concatenating)
